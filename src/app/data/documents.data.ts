...
export const PROFESSIONAL_DOCUMENTS: ProfessionalDocument[] = [
  ...
  },
  {
    ...
    description:
      'Spanish cover letter placeholder for role-specific professional introductions and application context.',
    type: 'Cover Letter',
    language: 'Spanish',
    group: 'Cover Letters',
    statusLabel: 'PDF placeholder',
  ...
  },
  {
    ...
    description:
      'English cover letter placeholder for role-specific professional introductions and application context.',
    type: 'Cover Letter',
    language: 'English',
    group: 'Cover Letters',
    statusLabel: 'PDF placeholder',
...
export const DOCUMENT_GROUPS: DocumentGroupSection[] = [
  ...
  },
  {
    id: 'cover-letters',
    title: 'Cover Letters',
    intro: 'Cover letter placeholders for role-specific professional introductions.',
  ...
  },
  {
    ...
    intro:
      'Recommendation letter placeholders intended to provide professional evidence from prior work contexts.',
